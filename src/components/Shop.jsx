            ...
            <div className="overflow-hidden mt-6">
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <button
                    className="flex"
                    data-uk-toggle="target: #product-nav"
                  >
            ...
            <div className="relative flex items-center justify-between mt-6 border-b hidden">
              ...
              >
                <li>
                  ...
                  >
                    <ion-icon className="mr-2 text-2xl" name="cart-outline" />
                    My Products
                  </a>
                </li>
                <li>
            ...
            <div className="p-6">
              ...
              <div>
                ...
                <p className="font-normal text-sm leading-6 mt-3">
                  ...
                  Deserunt, mollitia? Eaque consequuntur asperiores eos Fugiat
                  ullam
                </p>
              </div>
              ...
              <div className="space-y-2 text-sm mt-7">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    Free to use under Instello License
                  </div>
                </div>
              </div>
                  ...
                  >
                    ...
                    <div data-uk-scrollspy-class="uk-animation-slide-bottom-small">
                      <p className="text-sm text-center max-w-sm">
                        You can earn money by selling high-quality photos and
                        share them with your friends who are interested
                      </p>
                    </div>
                    ...
                    <div className="font-medium text-sm">
                      <div>
                        <label className="flex justify-center max-w-sm mx-auto text-center">
                          ...
                          />
                          <span className="ml-3">
                            I agree this product is mine and i take resposibilty
                            of this product for selling
                          </span>
                        </label>
                      </div>
                    </div>
