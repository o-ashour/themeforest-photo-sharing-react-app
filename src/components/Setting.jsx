                  ...
                  <div className="font-normal text-gray-400">
                    <div>
                      ...
                      <p className="mt-3 font-normal text-gray-600 dark:text-white">
                        ...
                        account and content outside of you preferred
                ...
                <div>
                  <div className="font-normal text-gray-400 text-sm">
                    ...
                    <div
                      ...
                      data-uk-scrollspy="target: > div; cls: uk-animation-slide-bottom-medium; delay: 100 ;repeat: true"
                    >
                      ...
                      <div className="w-full">
                        <label className="switch flex justify-between items-center cursor-pointer gap-4">
                          ...
                          <div className="flex-1 md:pr-8">
                            ...
                            <p className="">
                              You can receive notifications on your phone, so
                              you can stay up-to-date even when you’re on the go
                            </p>
                          </div>
                          <input type="checkbox" defaultChecked="" />
                          <span className="switch-button !relative" />
