      ...
      <div id="wrapper">
          ...
          >
            ...
            <nav className="flex-1 max-md:flex max-md:justify-around md:space-y-2">
              ...
              <div
                ...
                data-uk-drop="pos: left-center;animate-out: true; animation: uk-animation-slide-left-medium; mode:click; offset: 9"
              >
              ...
              {/* reels */}
              <a href="reels.html" className="active">
                <svg
                  id="icon__outline"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
        ...
        <main className="2xl:ml-[--w-side] xl:ml-[--w-side-md] md:ml-[--w-side-small]">
          <div className="flex justify-center items-center w-full min-h-screen relative">
            <div className="lg:rounded-xl shadow-xl bg-white relative lg:h-[calc(100vh-60px)] h-[calc(100vh-120px)]">
              <iframe
                className="rounded-xl aspect-[9/16] h-full"
                src="https://www.youtube.com/embed/JAJ8V9rSB6w"
                allowFullScreen=""
                uk-video="autoplay: inview"
                frameBorder={0}
              />
              {/* action buttons */}
              <div className="absolute bottom-0 md:-right-14 right-0 max-md:m-3 z-10">
                <div className="flex flex-col gap-4 text-sm dark:text-white">
                  <div>
                    <button
                      type="button"
                      className="bg-slate-200/80 p-2 rounded-full hover:scale-110 duration-200"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                    ...
                    <div className="mt-1 text-center">54 6K</div>
                  </div>
                  <div>
                    <button
                      type="button"
                    ...
                    <div className="mt-1 text-center">Dislike</div>
                  </div>
                  <div>
                    <button
                      type="button"
                    ...
                    <div className="mt-1 text-center">3.4K</div>
                  </div>
                  <div>
                    <button
                      type="button"
                    ...
                    <div className="mt-1 text-center">Share</div>
                  </div>
                  <div>
                    <button
                      type="button"
                    ...
                    <div
                      className="w-[253px]"
                      data-uk-dropdown="pos: bottom-right; offset: 10; animation: uk-animation-slide-bottom-small"
                    >
                      <nav>
                        <a href="#">
                          <ion-icon
                  ...
                  >
                    <img
                      src="assets/images/avatars/avatar-3.jpg"
                      alt=""
                      className="w-9 h-9 shadow object-cover rounded-full"
                    />
                  </a>
                </div>
              </div>
