...
import Peaple from './components/Peaple';
                ...
                >
                    ...
                    >
                        ...
                        <nav className="flex-1 max-md:flex max-md:justify-around md:space-y-2">
                            ...
                            {/* Explore */}
                            <Link to="/explore" className="max-md:!hidden">
                                <svg
                                    id="icon__outline"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor"
                            ...
                            {/* peaple */}
                            <Link to="/peaple" className="max-md:!hidden">
                                <svg
                                    id="icon__outline"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            {/* components */}
                            <Link to="/components" className="max-md:!hidden">
                                <svg
                                    id="icon__outline"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <Link to="/profile" className="max-md:!hidden">
                                <svg
                                    id="icon__outline"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
